...
// The "Spectrogram alignment with cursor at time=0" test was removed because
// it relied on getBoundingClientRect() which returns distorted projected
// coordinates under extreme 3D perspective (85deg tilt + scaleX narrowing).
// See PR #393 comment on constraints.
